...
# By default all these toolchains are registered by the gasworks_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:gasworks_toolchain",
    toolchain_type = "@rules_gasworks//gasworks:toolchain_type",
)
""".format(
            platform = platform,
