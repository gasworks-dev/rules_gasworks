...
some other ruleset that depends on rules_gasworks, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_gasworks=$(pwd)/rules_gasworks"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_gasworks` on your system will point to this folder.
